...
public class RinformParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RinformGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRoomAliasAccess().getGroup_5(), "rule__RoomAlias__Group_5__0");
			builder.put(grammarAccess.getRoomAliasAccess().getGroup_6(), "rule__RoomAlias__Group_6__0");
			...
			builder.put(grammarAccess.getItemAliasAccess().getGroup(), "rule__ItemAlias__Group__0");
			builder.put(grammarAccess.getItemAliasAccess().getGroup_5(), "rule__ItemAlias__Group_5__0");
			builder.put(grammarAccess.getItemAliasAccess().getGroup_6(), "rule__ItemAlias__Group_6__0");
			...
			builder.put(grammarAccess.getCharacterAliasAccess().getGroup(), "rule__CharacterAlias__Group__0");
			builder.put(grammarAccess.getCharacterAliasAccess().getGroup_5(), "rule__CharacterAlias__Group_5__0");
			builder.put(grammarAccess.getCharacterAliasAccess().getGroup_6(), "rule__CharacterAlias__Group_6__0");
			...
			builder.put(grammarAccess.getRoomAliasAccess().getRoomAssignment_2(), "rule__RoomAlias__RoomAssignment_2");
			builder.put(grammarAccess.getRoomAliasAccess().getAliasesAssignment_5_1(), "rule__RoomAlias__AliasesAssignment_5_1");
			builder.put(grammarAccess.getRoomAliasAccess().getAliasesAssignment_6_1(), "rule__RoomAlias__AliasesAssignment_6_1");
			...
			builder.put(grammarAccess.getItemAliasAccess().getItemAssignment_2(), "rule__ItemAlias__ItemAssignment_2");
			builder.put(grammarAccess.getItemAliasAccess().getAliasesAssignment_5_1(), "rule__ItemAlias__AliasesAssignment_5_1");
			builder.put(grammarAccess.getItemAliasAccess().getAliasesAssignment_6_1(), "rule__ItemAlias__AliasesAssignment_6_1");
			...
			builder.put(grammarAccess.getCharacterAliasAccess().getCharacterAssignment_2(), "rule__CharacterAlias__CharacterAssignment_2");
			builder.put(grammarAccess.getCharacterAliasAccess().getAliasesAssignment_5_1(), "rule__CharacterAlias__AliasesAssignment_5_1");
			builder.put(grammarAccess.getCharacterAliasAccess().getAliasesAssignment_6_1(), "rule__CharacterAlias__AliasesAssignment_6_1");
